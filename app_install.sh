...
sed -i "" -e "s/DOCKERUSER/$docker_username/g" $docker_username-nagios.json

echo " "
echo "***************************************************"
echo "Installing nagios as  class/$docker_username"
...
echo
echo "http://class-$docker_username.$mantl_domain/:8080"
echo
echo
